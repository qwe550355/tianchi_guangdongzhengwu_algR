...
def conv2d_atrous(x, W, bias):
    conv = tf.nn.atrous_conv2d(x, W, rate=2, padding="SAME")
    return tf.nn.bias_add(conv, bias)
...
def _compute_cross_entropy_mean(class_weights, labels, logits):
